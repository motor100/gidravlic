...
<div class="company">
  ...
  <div class="company-item page-item">
    ...
    <div class="company-content page-item__content">
      ...
      <p>В ассортименте интернет-магазина представлено более 10 тысяч наименований, все они имеются в наличии на складе. Представленные в каталоге системы, узлы и механизмы соответствуют техническим требованиям, имеют соответствующее качество. Все поставки в интернет-магазин осуществляются официально, продукция имеет необходимые сертификаты соответствия.</p>
      ...
      <ul>
        ...
        <li>Редукторы и мультипликаторы Итальянского производства</li>
      </ul>
  ...
  <div class="company-item page-item">
    ...
    <div class="company-content page-item__content">
      ...
      <p>ИНН: 7415113283</p>
      <p>КПП: 741501001</p>
      <p>Р/счёт: № 40702810838090010091 в филиал «Екатеринбурский» АО «Альфа-банк»</p>
      <p>К/счёт: № 30101810100000000964</p>
      <p>БИК: 046577964</p>
    </div>
  </div>
